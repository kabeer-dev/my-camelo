...
import PaymentVerification from "./components/paymentconfirmation/PaymentVerification";
import AgentPaymentVerification from "./components/agent/paymentconfirmation/AgentPaymentVerification";
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route
          path="/mashrouk-new-ui/create-new-account"
          element={<SignUp />}
        />
        <Route path="/mashrouk-new-ui/otp" element={<OTPScreen />} />
        <Route path="/mashrouk-new-ui/phone-signup" element={<PhoneSignUp />} />
        <Route
          path="/mashrouk-new-ui/user-registration"
          element={<UserRegistration />}
        />
        <Route
          path="/mashrouk-new-ui/forget-password"
          element={<ForgetPassword />}
        />
        <Route
          path="/mashrouk-new-ui/forget-password-otp"
          element={<ForgetOtpScreen />}
        />
        <Route
          path="/mashrouk-new-ui/reset-password"
          element={<ResetPassword />}
        />
        {isLoggedIn && (
          <Route path="/mashrouk-new-ui/my-bookings" element={<MyBooking />} />
        )}
        {isLoggedIn && (
          <Route path="/mashrouk-new-ui/my-profile" element={<MyProfile />} />
        )}
        <Route
          path="/mashrouk-new-ui/payment-confirmation"
          element={<PaymentMethodForm />}
        />
        <Route
          path="/mashrouk-new-ui/payment-success"
          element={<PaymentSuccess />}
        />
        <Route
          path="/mashrouk-new-ui/payment-failed"
          element={<PaymentFailed />}
        />
        <Route path="/mashrouk-new-ui/email-sent" element={<EmailSentPage />} />
        <Route
          path="/mashrouk-new-ui/payment-verification"
        ...
        <Route
          path="/mashrouk-new-ui/request-submit"
          element={<RequestSubmit />}
        />
        <Route
          path="/mashrouk-new-ui/request-failed"
        ...
        <Route
          path="/mashrouk-new-ui/agent/create-new-account"
          element={<AgentSignUp />}
        />
        <Route path="/mashrouk-new-ui/agent/otp" element={<AgentOTPScreen />} />
        <Route
          path="/mashrouk-new-ui/agent/phone-signup"
          element={<AgentPhoneSignUp />}
        />
        <Route
          path="/mashrouk-new-ui/agent/user-registration"
          element={<AgentUserRegistration />}
        />
        {isLoggedIn && (
          <Route
            path="/mashrouk-new-ui/agent/my-bookings"
            element={<AgentMyBooking />}
          />
        )}
        <Route
          path="/mashrouk-new-ui/agent/payment-confirmation"
          element={<AgentPaymentMethodForm />}
        />
        <Route
          path="/mashrouk-new-ui/agent/payment-success"
          element={<AgentPaymentSuccess />}
        />
        <Route
          path="/mashrouk-new-ui/agent/payment-failed"
          element={<AgentPaymentFailed />}
        />
        <Route
          path="/mashrouk-new-ui/agent/email-sent"
          element={<AgentEmailSentPage />}
        />
        <Route
          path="/mashrouk-new-ui/agent/thank-you"
          element={<AgentThankYou />}
        />
        <Route
          path="/mashrouk-new-ui/agent/payment-verification"
          element={<AgentPaymentVerification />}
        />
        <Route
          path="/mashrouk-new-ui/agent/terms-condition"
          element={<Terms />}
        />

        <Route path="/mashrouk-new-ui/*" element={<NotFound />} />
        <Route
          path="/mashrouk-new-ui/under-maintenance"
          element={<UnderMaintenance />}
        />
        {/* <Route path="/mashrouk-new-ui/" element={<TemporarilyUnavailable />} /> */}
