              ...
              {showAlreadyRegistered && (
                <>
                  ...
                  <div className="text-center mt-6 flex flex-row justify-between items-center">
                    <Button
                      className="bg-bg_btn_back cursor-pointer w-1/2 text-text_white hover:bg-gray-100 font-medium rounded text-sm px-5 py-2.5 me-2 mb-2"
                      onClick={() => {
                    ...
                    />
                    <Button
                      className="bg-background_steel_blue cursor-pointer w-1/2 text-text_white hover:bg-gray-100 font-medium rounded text-sm px-5 py-2.5 me-2 mb-2"
                      label={t("login_text")}
                      type="submit"
                    />
                  </div>
                ...
                <>
                  ...
                  <div className="mt-2 flex flex-row justify-start items-center">
                    <div className="mr-1">
                      {showResend ? (
                        <Button
                          className="bg-background_steel_blue cursor-pointer w-20 text-center text-text_white hover:bg-gray-100 font-medium rounded text-sm px-1 py-2 me-2 mb-2"
                          label={t("resend_text")}
                          type="button"
                  ...
                  <div className="my-3 flex flex-row justify-between items-center">
                    <Button
                      className="bg-bg_btn_back w-1/2 cursor-pointer text-text_white hover:bg-gray-100 font-medium rounded text-sm px-5 py-2.5 me-2 mb-2"
                      onClick={() => {
