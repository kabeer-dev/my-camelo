...
import LeftVector from "../assets/signin/left_vector.png";
import RightVector from "../assets/signin/right_vector.png";
import LogoVector from "../assets/signin/logo.png";
...
export default function UserRegistration() {
  ...
  const onSubmit = async (values, { setSubmitting }) => {
    ...
    if (!recaptchaToken) {
      message.error(t("reCaptcha Token is required"));
    } else {
      const headers = {
                            ...
                            <div className="flex flex-col  md:flex-row justify-between items-center">
                              <div className="w-full md:w-1/2 mr-0 md:mr-1">
                                <InputFieldFormik
                                  ...
                                  placeholder={t("my_profile.first_name_text")}
                                  name="rider_name"
                                  type="text"
                                  onChange={(valueObj) => {
                              ...
                              <div className="w-full md:w-1/2 ml-0 md:ml-1">
                                <InputFieldFormik
                                  ...
                                  placeholder={t("my_profile.last_name_text")}
                                  name="lastName"
                                  type="text"
                                  onChange={(valueObj) => {
                                    const { fieldName, selectedValue } =
                        ...
                        {activeStepId === 2 && (
                          <>
                            ...
                            <div className="w-full mt-3 flex flex-col md:flex-row justify-between items-center">
                              <Button
                                className="bg-bg_btn_back cursor-pointer w-full md:w-1/2 text-text_white hover:bg-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 me-0 md:me-2"
                                onClick={() => {
                                  setActiveStepId(1);
                                }}
                              ...
                              /> */}
                              <Button
                                className="bg-background_steel_blue cursor-pointer w-full md:w-1/2 text-text_white hover:bg-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 me-0 md:me-2"
                                label={t("submit_text")}
                                type="submit"
                              />
                            </div>
