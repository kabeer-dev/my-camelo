  ...
  const handleVerify = useCallback(async () => {
    ...
    try {
      ...
      if (response?.status === 200) {
        ...
        navigate("/mashrouk-new-ui/agent/phone-signup", {
          state: { email: email },
        });
        ...
        <div className="z-20 w-screen h-screen flex flex-row justify-center items-center">
          <div className="flex flex-col justify-center items-center">
            ...
            <div className="mt-4 block w-72 md:w-auto p-3 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
              <div
                className="w-auto md:w-[400px] text-left rtl:text-right p-4"
                dir={language === "ar" ? "rtl" : "ltr"}
              >
                <Heading
              ...
              <div>
                <div className="p-2 md:p-4">
                  ...
                  {error && (
                    <div
                      className="text-base text-text_warning font-semibold my-2"
                      dir={language === "ar" ? "rtl" : "ltr"}
                    >
                      {error}
                    </div>
                  ...
                  <div
                    className="mt-2 flex flex-row justify-start items-center"
                    dir={language === "ar" ? "rtl" : "ltr"}
                  >
                    <div className="mr-1">
                      {showResend ? (
