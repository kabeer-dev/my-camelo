      ...
      if (response?.status === 200) {
        try {
          ...
          if (otpResponse?.status === 200) {
            ...
            navigate("/mashrouk-new-ui/otp", { state: { email: values.email } });
                ...
                <div className="p-2 md:p-4"  dir={language === 'ar' ? 'rtl' : 'ltr'}>
                  ...
                  >
                    <Form>
                      ...
                      <div className="mt-2 w-full text-sm flex items-center justify-center text-text_lightdark_grey cursor-pointer" dir={language === 'ar' ? 'rtl' : 'ltr'}>
