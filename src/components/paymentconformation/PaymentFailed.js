...
import PaymentFailedLogo from '../../assets/payment-logos/paymentFailedLogo.png'
                ...
                <div className="container mx-auto p-4">
                    <div className="grid grid-cols-1 gap-3">
                        <div className="mx-auto">
                            <img src={PaymentFailedLogo} />
                        </div>
                    </div>
                    <div className="grid grid-cols-1 gap-3">
                        <div className="mx-auto">
                            <p className="font-extrabold mt-6 font-roboto">payment failed</p>
                        </div>
                    </div>
                    <div className="grid grid-cols-1 gap-3">
                        <div className="mx-auto">
                            <p className="mt-2 font-roboto text-text_lightdark_grey">Payments fail, check whether you or the card issuing bank have sufficient balance</p>
                        </div>
                    </div>
