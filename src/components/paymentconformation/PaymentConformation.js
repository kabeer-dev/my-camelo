...
export default function PaymentConformation() {
    ...
    const onSubmit = (values, { setSubmitting }) => {
        ...
        if (values.cardName.toLowerCase() !== 'visa' || values.firstName.toLowerCase() !== 'azhar' || values.surname.toLowerCase() !== 'abbas' || values.cardNumber !== 123456789 || values.cvc !== 123) {
            // values.cardName.toLowerCase() !== 'visa' && message.error("Card Name is incorrect")
            // values.firstName.toLowerCase() !== 'azhar' && message.error("First Name is incorrect")
            // values.surname.toLowerCase() !== 'abbas' && message.error("Surname is incorrect")
            // values.cardNumber !== 123456789 && message.error("Card Number is incorrect")
            // values.cvc !== 123 && message.error("CVC is incorrect")
            navigate('/mashrouk-new-ui/payment-failed')
        } else {
            navigate('/mashrouk-new-ui/payment-success')
        }
        setSubmitting(false);
    };
