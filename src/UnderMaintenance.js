      ...
      <div className="h-screen w-screen position relative">
        ...
        <main dir={language === 'ar' ? 'rtl' : 'ltr'}>
          ...
          <div className="mx-auto p-4 h-screen flex items-center justify-center">
            <div >
              <img src="/assets/maintainance/underMaintenance.png" alt="404 Page" className="m-auto"/>
              <h1 className="text-center text-2xl font-bold mt-4">{t("maintenance_text")}</h1>
              <div className="flex justify-center w-full mt-4">
                <button
                  className="flex items-center px-4 py-2 border border-gray-400 rounded-full text-gray-700 hover:bg-gray-100"
                  onClick={() => window.location.href = '/'} // or use a link component if using a router
                >
